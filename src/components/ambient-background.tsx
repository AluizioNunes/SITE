export default function AmbientBackground() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
      ...
      <div className="absolute left-1/2 top-[28rem] h-[32rem] w-[32rem] -translate-x-1/2 rounded-full bg-black/5 blur-3xl dark:bg-white/5" />
    </div>
  );
}
